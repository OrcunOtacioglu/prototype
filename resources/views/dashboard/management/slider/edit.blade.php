...
@section('content')
    ...
    <form action="{{ action('SliderController@update', ['id' => $slider->id]) }}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{ method_field('PUT') }}
        <div class="row">
            <div class="col-md-8">
                <div class="panel panel-primary panel-line">
                    ...
                    <div class="panel-body">
                        <img src="{{ env('APP_URL') }}/images/slider-images/{{ $slider->img_path }}" alt="" class="img-thumbnail">
                            ...
                            <div class="input-group input-group-file" data-plugin="inputGroupFile">
                                ...
                                <span class="input-group-btn">
                                    <span class="btn btn-primary btn-file">
                                        ...
                                        <input type="file" name="slider_bg" id="slider_bg" value="{{ $slider->img_path }}">
                                    </span>
                                </span>
                            </div>
                        </div>
